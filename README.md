...
[![readthedoc](https://readthedocs.org/projects/buzzard/badge/?version=latest&style=flat)](https://buzzard.readthedocs.io/en/latest)
...
Additional examples can be found here: [jupyter notebook](./docs/examples.ipynb).
